...
import { Clock, CheckCircle, ChefHat, Archive, AlertTriangle, Utensils, Bell, Footprints, UtensilsCrossed } from 'lucide-react';
        ...
        <div className="flex items-center space-x-2">
          ...
          {order.status === 'PICKED_UP' && (
            <button
              ...
              className="bg-gradient-to-r from-blue-500 to-cyan-500 hover:from-blue-600 hover:to-cyan-600 text-white font-extrabold text-[11px] px-3.5 py-2 rounded-xl shadow-lg shadow-blue-500/20 flex items-center space-x-1.5 transition-all duration-300 active:scale-95"
            >
              <UtensilsCrossed className="w-3.5 h-3.5" />
              <span>Servie à Table</span>
            </button>
          )}
          ...
          {order.status === 'PAID' && (
            <button
              ...
              className="bg-white/[0.04] hover:bg-white/[0.08] text-gray-300 hover:text-white font-bold text-[11px] px-3 py-2 rounded-xl border border-white/[0.06] flex items-center space-x-1.5 transition-all duration-300 active:scale-95"
              title="Archiver la commande payée"
            >
